...
<head>
  ...
  <title>ดัชนีความเชื่อถือได้ SEPA Focus Group (E)</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ดัชนีความเชื่อถือได้ SEPA Focus Group (E)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">SEPA Foucs Group (E)</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script src="dist/js/verify-sepa-focus-group-index.js"></script>
