...
<head>
  ...
  <title>ค้นหาสถิติสายส่งไฟฟ้าดับ</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ค้นหาสถิติสายส่งไฟฟ้าดับ</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ค้นหาสถิติไฟฟ้าดับ สายส่ง</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#line" data-toggle="tab">ค้นหารายสายส่ง</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="line">
                    <!-- Search with Line -->
                    <form class="form-horizontal">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">สายส่ง</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="lineName" placeholder="ตัวอย่าง: ชื่อสายส่ง เช่น bot-693 หรือชื่อสถานีฯ เช่น bot เป็นต้น">
                          <div class="custom-control custom-checkbox mt-2">
                            <input class="custom-control-input" type="checkbox" id="allLine" value="allLine">
                            <label for="allLine" class="custom-control-label" style="font-weight: 400;">เลือกทุกสายส่ง</label>
                          </div>
                          <div class='text-danger mt-2 d-none'>ระบุชื่อสายส่ง เช่น bot-693 หรือชื่อสถานีฯ เช่น bot หรือเลือกทุกสายส่ง</div>
                        </div>
                      </div>
                    </form>
                    <!-- /.Search with Line -->
...
<script src="dist/js/search-line-index.js"></script>
</body>
</html>
