...
<head>
  ...
  <title>ดัชนีความเชื่อถือได้ นิคมอุตสาหกรรม</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ดัชนีความเชื่อถือได้ นิคมอุตสาหกรรม</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">นิคมอุตสาหกรรม</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <section class="row">
          ...
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">นิคมอุตสาหกรรม (รวม)</h4>
          </div>
          <!-- BAR CHART Industiral-saifi -->
          <div class="col-lg-6">
        ...
        <section class="row">
          <!-- Charts Header -->
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">นิคมฯ บางชัน</h4>
          </div>
          <!-- BAR CHART H-saifi -->
          <div class="col-lg-6">
            <div class="card card-secondary">
        ...
        <section class="row">
          <!-- Charts Header -->
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">นิคม ลาดกระบัง</h4>
          </div>
          <!-- BAR CHART L-saifi -->
          <div class="col-lg-6">
            <div class="card card-secondary">
        ...
        <section class="row">
          <!-- Charts Header -->
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">นิคมฯ บางพลี</h4>
          </div>
          <!-- BAR CHART P-saifi -->
          <div class="col-lg-6">
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartCanvas7" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <table id="tableCanvas7" class="table table-striped text-nowrap d-none">
                  <thead>
                    <tr>
                        <th>#</th>
                        <th>ม.ค.</th>
          ...
          <div class="col-lg-6">
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartCanvas8" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <table id="tableCanvas8" class="table table-striped text-nowrap d-none">
                  <thead>
                    <tr>
                        <th>#</th>
                        <th>ม.ค.</th>
        ...
        <section class="row">
          <!-- Charts Header -->
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">นิคมฯ บางปู</h4>
          </div>
          <!-- BAR CHART U-saifi -->
          <div class="col-lg-6">
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartCanvas9" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <table id="tableCanvas9" class="table table-striped text-nowrap d-none">
                  <thead>
                    <tr>
                        <th>#</th>
                        <th>ม.ค.</th>
          ...
          <div class="col-lg-6">
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartCanvas10" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <table id="tableCanvas10" class="table table-striped text-nowrap d-none">
                  <thead>
                    <tr>
                        <th>#</th>
                        <th>ม.ค.</th>
        ...
        <!-- Asia Suvarnabhumi Charts -->
        <section class="row">
          <!-- Charts Header -->
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">นิคมฯ เอเชีย (สุวรรณภูมิ)</h4>
          </div>
          <!-- BAR CHART A-saifi -->
          <div class="col-lg-6">
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartCanvas11" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <table id="tableCanvas11" class="table table-striped text-nowrap d-none">
                  <thead>
                    <tr>
                        <th>#</th>
                        <th>ม.ค.</th>
          ...
          <div class="col-lg-6">
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartCanvas12" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <table id="tableCanvas12" class="table table-striped text-nowrap d-none">
                  <thead>
                    <tr>
                        <th>#</th>
                        <th>ม.ค.</th>
...
<script src="dist/js/industrial-index.js"></script>
<!-- add-scirpt -->
<?php 
