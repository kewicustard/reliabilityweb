...
<head>
  ...
  <title>ดัชนีความเชื่อถือได้ ยุทธศาสตร์(S)</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ดัชนีความเชื่อถือได้ ตามแผนยุทธศาสตร์ (S)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ยุทธศาสตร์ (S)</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <section class="row">
          <!-- Charts Header -->
          <div class="col-12 mb-1">
            <h4 class="m-0 text-dark">กฟผ. และกฟภ.</h4>
          </div>
          <!-- BAR CHART S-saifi -->
          <div class="col-lg-6">
            <div class="card card-secondary">
...
<script src="dist/js/verify-strategy-index.js"></script>
<!-- add-scirpt -->
<?php 
