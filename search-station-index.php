...
<head>
  ...
  <title>ค้นหาสถิติสถานีฯ ไฟฟ้าดับ</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ค้นหาสถิติสถานีฯ ไฟฟ้าดับ</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ค้นหาสถิติไฟฟ้าดับ สถานีฯ</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#station" data-toggle="tab">ค้นหารายสถานีฯ</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="station">
                    <!-- Search with Ststion -->
                    <form class="form-horizontal">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">สถานีฯ</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="stationName" placeholder="ตัวอย่าง: ชื่อสถานีฯ เช่น ba, bot เป็นต้น">
                          <div class="custom-control custom-checkbox mt-2">
                            <input class="custom-control-input" type="checkbox" id="allStation" value="allStation">
                            <label for="allStation" class="custom-control-label" style="font-weight: 400;">เลือกทุกสถานีฯ</label>
                          </div>
                          <div class='text-danger mt-2 d-none'>ระบุชื่อสถานีฯ เช่น bot หรือเลือกทุกสถานีฯ</div>
                        </div>
                      </div>
                    </form>
                    <!-- /.Search with Station -->
...
<script src="dist/js/search-station-index.js"></script>
</body>
</html>
